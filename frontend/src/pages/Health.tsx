    ...
    <main className="mx-auto max-w-[640px] px-5 py-5">
      ...
      {view === "journal" ? <div>
        ...
        {reportLoading ? <div className="skeleton h-40 rounded-lg" /> : report && <div className="space-y-7">
          ...
          <button onClick={() => navigate("/assistant/chat")} className="flex h-11 w-full items-center justify-center gap-2 rounded-lg border border-border bg-card text-sm font-semibold text-text2"><Bot size={17} />和 AI 助手聊饮食规划</button>
