...
type MealRecord struct {
	...
	MealType  string    `json:"meal_type" gorm:"not null;size:16;index;uniqueIndex:idx_meal_records_user_unique_day,priority:3;index:idx_meal_records_date_type,priority:2"`
	MealDate  string    `json:"meal_date" gorm:"not null;size:10;index;uniqueIndex:idx_meal_records_user_unique_day,priority:4;index:idx_meal_records_date_type,priority:1;index:idx_meal_records_user_date,priority:2"`
